...
\\
\solution
\input{solutions/ma/2018/23/main.tex}
%
...
\\
\solution
\input{solutions/st/2019/45.tex}
...
%
\solution
  \input{solutions/ma/2018/24/main.tex}
%
...
\solution
  \input{solutions/st/2021/50/main.tex}
...
%
\solution
  \input{solutions/ma/2001/2.23/main.tex}
  %
...
\\
\solution
  \input{solutions/ma/2016/46.tex}
%
\item Let X be a random variable with characteristic function $\phi_X(\cdot)$ such that $\phi_X(2 \pi)=1$.Let $\mathbb{Z}$ denote the set of integers.Then $P(X \in \mathbb{Z})$ is equal to $\ldots$
%
\solution
  \input{solutions/st/2019/49.tex}
%
...
\\
\solution
  \input{solutions/ma/2016/48.tex}
%
...
\\
\solution 
  \input{solutions/cs/2016/29.tex}
%
...
\end{align}
\solution 
  \input{solutions/st/2020/23.tex}
%
...
\solution 
  \input{solutions/challenge/1.tex}
